...
- Framework : `pytest`
- Emplacement : `tests/` (`test_config.py`, `test_data_loader.py`, `test_ui_sanity.py`, `test_file_preview_nav.py`, `test_search_index.py`, `test_search_ui.py`) — 100 tests
...
- `VERSION` : fichier unique définissant la version officielle (`2.1`).
...
- `antigravity_manager.py` : interface graphique moderne **PyQt6** (v2.1) :
